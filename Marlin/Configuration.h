...
#define CUSTOM_MACHINE_NAME "C4 2.0.7.2 261120"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  39.51
    #define DEFAULT_Ki   3.8
    #define DEFAULT_Kd 102.76
  #endif
#endif // PIDTEMP
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 99.40, 99.70, 395.26, 137.25 }
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.0095 // (mm) Distance from real junction edge
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 26, 9, -0.35 }
...
#define HOMING_FEEDRATE_Z  (800) //(16*60)
