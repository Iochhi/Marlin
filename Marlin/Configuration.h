...
#define CUSTOM_MACHINE_NAME "C1 2.0.7.2 1112-20"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 120, 120, 35, 120 }
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.0205 // (mm) Distance from real junction edge
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 23, 8, -1.25 }
...
#define HOMING_FEEDRATE_Z  (800) //(15*60)
