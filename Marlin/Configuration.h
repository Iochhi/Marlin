...
#define STRING_CONFIG_H_AUTHOR "Carlos Patricio" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "C1 2.1.2.4 2008-24"
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 32.42
  #define DEFAULT_bedKi 6.48
  #define DEFAULT_bedKd 108.19
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 23, 8, -0.4 }
...
#define Z_PROBE_FEEDRATE_FAST (20*60) //4 Verificar
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT (46) //X_CENTER  // (mm) X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT (35) //Y_CENTER  // (mm) Y point for Z homing
#endif
