...
#define CUSTOM_MACHINE_NAME "C4 2.0.7.2 061220 SKR-14T"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 99.75, 99.80, 396.85, 141.5 }
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.0250 // (mm) Distance from real junction edge
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 26, 9, -0.75 }
