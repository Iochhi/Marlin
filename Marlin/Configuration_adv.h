...
#define INPUT_SHAPING_Y
    ...
    #define SHAPING_FREQ_Y  41          // (Hz) The default dominant resonant frequency on the Y axis.
 ...
 */
#define ADVANCED_PAUSE_FEATURE //ACTIVAR CON PANTALLA
...
// M42 - Set pin states
//
//#define DIRECT_PIN_CONTROL //Quitar despues de Probar pines

//
// M43 - display pin status, toggle pins, watch pins, watch endstops & toggle LED, test servo probe
//
//#define PINS_DEBUGGING //Quitar despues de Probar pines
